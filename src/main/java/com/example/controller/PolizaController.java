...
public class PolizaController {
    ...
    public ResponseEntity<?> crearPolizaInmueble(@PathVariable int idPoliza, @RequestBody PolizaInmuebleDTO polizaInmuebleDTO) throws PolizaNoEncontradaException {
        ApiResult<?> apiResult = polizaService.crearPolizaInmueble(idPoliza, polizaInmuebleDTO);
    ...
    public ResponseEntity<?> editarDetallesInmueble(@PathVariable int idPoliza, @RequestBody PolizaInmuebleDTO polizaInmuebleDTO) throws PolizaNoEncontradaException {
        ApiResult<?> apiResult = polizaService.editarDetallesInmueble(idPoliza, polizaInmuebleDTO);
        return ResponseEntity.status(200).body(apiResult);
    }
